...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '大头', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个期货从业者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.datou.ac.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '期货, 博客, 金融, 投资, 基本面分析', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'liuyingpeng1998@icloud.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/110688826?spm_id_from=333.1007.0.0', // B站主页
